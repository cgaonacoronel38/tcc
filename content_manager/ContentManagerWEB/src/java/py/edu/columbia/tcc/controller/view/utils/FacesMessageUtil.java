...
/**
 * Utility class to help JSF developers create <code>FacesMessage</code> passing
 * normal String, or retrieve values from UIResources.properties file. The
 * created <code>FacesMessage</code> can be added to a desired
 * <code>UIComponent</code>, or the current <code>FacesContext</code>.
 *
...
public class FacesMessageUtil {
    ...
    /**
     * Returns a string value from the <code>UIResources.properties</code>
     * bundle associated with the given key, localized, and formatted with the
     * given parameters, if any.
     *
     * @param key The string key in the loaded resource bundle.
     * @param locale Defines the localization file.
     * @param params Optional parameters to format the string using
     * <code>MessageFormat</code>.
     * @return The string value from the resource bundle associated with the
     * given key, formatted with the given parameters, if any.
    ...
    /**
     * Retrieve a defined string from the given bundle file, according to the
     * passed key.
     *
     * @param key The string key in the loaded resource bundle.
     * @param bundle The <code>ResourceBundle</code> file where the key is
     * located.
     * @param params Optional parameters to format the message using
     * <code>MessageFormat</code>.
     * @return The string value from the given bundle file matching the given
     * key.
     */
    ...
    /**
     * Add a <code>FacesMessage</code> from the loaded
     * <code>ResourceBundle</code> file, to the current
     * <code>FacesContext</code>, with a defined severity.
     *
     * @param severity <code>FacesMessage.Severity</code> defines the
     * <code>FacesMessage</code> status of four options,
     * <code>FacesMessage.SEVERITY_INFO</code>,
     * <code>FacesMessage.SEVERITY_WARN</code>,
     * <code>FacesMessage.SEVERITY_ERROR</code>,
     * <code>FacesMessage.SEVERITY_FATAL</code>.
     ...
     * @param params Optional parameters to format the message using
     * <code>MessageFormat</code>.
     * @see FacesMessageUtil#addBundledFacesMessage(UIComponent,
     * FacesMessage.Severity, String, String, Object[])
     */
    ...
    /**
     * Add a <code>FacesMessage</code>, to the current
     * <code>FacesContext</code>, with a defined severity.
     *
     * @param severity <code>FacesMessage.Severity</code> defines the
     * <code>FacesMessage</code> status of four options,
     ...
     * @see FacesMessageUtil#addFacesMessage(UIComponent, FacesMessage.Severity,
     * String, String)
     */
    ...
    /**
     * Add a <code>FacesMessage</code> from the loaded
     * <code>ResourceBundle</code> file, to the given <code>UIComponent</code>,
     * with a defined severity.
     *
     * @param component The <code>UIComponent</code> to associate the created
     * <code>FacesMessage</code> with.
     * @param severity <code>FacesMessage.Severity</code> defines the
     * <code>FacesMessage</code> status of four options,
     * <code>FacesMessage.SEVERITY_INFO</code>,
     * <code>FacesMessage.SEVERITY_WARN</code>,
     ...
     * @param params Optional parameters to format the message using
     * <code>MessageFormat</code>.
     * @see FacesMessageUtil#newBundledFacesMessage(FacesMessage.Severity,
     ...
     * @param summary The summary message.
     * @param detail The detail message.
     * @see FacesMessageUtil#newFacesMessage(FacesMessage.Severity, String,
     * String)
     */
    ...
    /**
     * Get a new <code>FacesMessage</code> object with the given summary,
     * detail, and the passed severity status.
     *
     * @param severity <code>FacesMessage.Severity</code> defines the
     * <code>FacesMessage</code> status of four options,
     * <code>FacesMessage.SEVERITY_INFO</code>,
    ...
    /**
     * Get a new <code>FacesMessage</code> object, from the loaded
     * <code>ResourceBundle</code> file, with the given summary, detail, and the
     * passed severity status.
     *
     * @param severity <code>FacesMessage.Severity</code> defines the
     * <code>FacesMessage</code> status of four options,
     * <code>FacesMessage.SEVERITY_INFO</code>,
    ...
    /**
     * Retrieve the set <code>Locale</code> in the <code>UIViewRoot</code> of
     * the current <code>FacesContext</code>.
     *
     * @param context The current <code>FacesContext</code> object to reach the
     * JSF pages <code>UIViewRoot</code>.
    ...
    /**
     * Set the Locale in the <code>UIViewRoot</code> of the current
     * <code>FacesContext</code>.
     *
     * @param locale The required <code>Locale</code> value to set in the
