...
@ManagedBean(name = "contentDashboard")
@ViewScoped
public class ContentDashboard implements Serializable {
    ...
    public void deleteChart(String chartID) {
        try {
            ...
            try {
                ...
                Logger.getLogger(ContentDashboard.class.getName()).log(Level.SEVERE, null, e);
            }
