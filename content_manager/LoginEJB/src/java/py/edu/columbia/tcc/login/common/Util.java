...
public class Util {
    ...
    private static String JAR_NAME = "TCCEJB.jar";
     ...
     * @throws com.documenta.util.exception.DcorsEJBException
     */
    public String getApplicationConfigPath(boolean db2ExternalFunction) throws Exception {
        String appPath = null;
        ...
        if(!db2ExternalFunction) {
            ...
            throw new Exception("No se puede obtener la ruta para el archivo de configuración.");
        }
        
        return appPath;
    }
    
    private String getPathForJar() throws Exception {
        ...
        if(posJarName > 0){
            ...
            throw new Exception("No se pudo obtener la ruta relativa de ejecución de la aplicacíón.");
        }
    }
