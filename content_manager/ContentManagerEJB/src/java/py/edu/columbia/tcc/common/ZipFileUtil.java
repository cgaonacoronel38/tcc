...
public class ZipFileUtil {
     ...
     * @throws GDMException 
     */
    public void create(String zipFileName) throws GDMException {
        try {
            ...
            throw new GDMException("No se pudo inicializar el nuevo archivo zip: " + this.zipFileName, ex);
        }
    }
     ...
     * @throws GDMException 
     */
    public void addEntryFile(String entryFileName) throws GDMException {
        FileInputStream fis = null;
        BufferedInputStream bis = null;
        
        if(zos == null) {
            throw new GDMException("Debe crear el archivo zip antes de agregar entradas.");
        }
        ...
        try {
            ...
            throw new GDMException("No se pudo agregar el archivo: " + entryFileName + " en el archivo zip: " + zipFileName, ex);
        } finally {
            try {
     ...
     * @throws GDMException 
     */
    public long close() throws GDMException {
        if(zos == null) {
            throw new GDMException("El archivo zip no fue creado.");
        }
        ...
        try {
            ...
            throw new GDMException("No se pudo cerrar el archivo zip: " + zipFileName, ex);
        }
    }
