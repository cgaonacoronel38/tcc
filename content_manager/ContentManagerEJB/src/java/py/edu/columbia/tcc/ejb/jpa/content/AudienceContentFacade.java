 ...
 */
@Stateless
public class AudienceContentFacade extends AbstractFacade<AudienceContent> {

    public AudienceContentFacade() {
        super(AudienceContent.class);
    }
    ...
    public List<ChartDeviceBean> getChartDevices(Integer idFilterSetting) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AudienceContentFacade.class.getName()).log(Level.SEVERE, null, ex);
        }
